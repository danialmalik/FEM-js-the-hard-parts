// Challenge 1
/**
 * Let's start by reviewing asynchronous functions! Using setTimeout,
 *  print the string 'Hello!' after 1000ms.
 */
function sayHello() {
...
// Challenge 3
/**
 * Create another promise. Now have it reject with a value of "Rejected!"
 *  without using setTimeout.
 *  Print the contents of the promise after it has been rejected by passing
 ...
 * Create a promise and have it resolve with the value of
 * "Promise has been resolved!" Then uncomment the code at bottom of Challenge 4.
 ...
 * Create two variables: firstPromise and secondPromise Set
 * secondPromise to be a promise that resolves to "Second!"
 * Set firstPromise to be a promise that resolves to secondPromise
 * Call the firstPromise with a ".then", which will return the
 * secondPromise> promise. Then print the contents of the promise
 * after it has been resolved by passing console.log to .then
 */


var secondPromise = new Promise((resolve, _) => resolve('Second!'))
var firstPromise = new Promise((resolve, _) => resolve(secondPromise))
 ...
 * Your challenge is to use Promise.all to make 3 API
 * calls and return all the data when the calls are complete
 */
const fakePeople = [
